<!-- Begin Page Content -->
<link rel="stylesheet" type="text/css" href="../style/listsp.css">
<div class="container-fluid">
    ...
    <form action="?act=listsp" method="post">
        <div class="card shadow mb-4">
                ...
                <div class="float-right">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary tim" type="submit" name="search">
                            Search
                            </button>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            foreach ($listsp as $sp) {
                                ...
                                echo '<tr>
                                        ...
                                        <td  class="col-1 align-middle">'.$khuyenmai.'</td>
            ...
            <a href="?act=addsp"><button type="button" class="btn btn-secondary btn-sm nhap">Nhập thêm</button></a>
        </div>
    </form>
</div>
<!-- /.container-fluid -->